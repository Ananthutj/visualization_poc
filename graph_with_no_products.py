#This is the code for the graph with no products shown in the nodes
...
def add_node(node, color):
    ...
    rows = f"""
    <TR><TD ALIGN="CENTER" BORDER="0" SIDES="BOTTOM" CELLPADDING="3" 
    BALIGN="CENTER" VALIGN="MIDDLE">{header_lines}</TD></TR>
    """
