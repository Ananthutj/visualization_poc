...
relation_color_list = [
    "#E74C3C", "#27AE60", "#2980B9", "#8E44AD", "#F39C12", "#16A085", "#2C3E50",
    "#D35400", "#7F8C8D", "#C0392B", "#9B59B6", "#1ABC9C"
]
...
# Adjust physics settings for spacing
net.set_options("""
var options = {
  "physics": {
    "barnesHut": {
...
"""
#<u>Edge Colors (Relation):</u><br>
#for rel, color in relation_color_map.items():
#    legend_html += f'<span style="color:{color}; font-weight:bold;">━►</span> {rel}<br>'
#legend_html += "</div>"
